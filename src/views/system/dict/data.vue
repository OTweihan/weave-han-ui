  ...
  <div class="h-full flex flex-col">
      ...
      <div v-show="showSearch" class="mb-[10px]">
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            <el-form-item label="字典名称" prop="dictType" v-if="false">
    ...
    <el-card shadow="hover" class="flex-1 flex flex-col overflow-hidden table-card">
      ...
      <div class="flex-1 min-h-0">
        <el-table v-loading="loading" border :data="dataList" @selection-change="handleSelectionChange" height="100%">
