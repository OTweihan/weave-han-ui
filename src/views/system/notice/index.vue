  ...
  <div class="p-2 h-full flex flex-col">
      ...
      <div v-show="showSearch" class="mb-[10px]">
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            ...
            <el-form-item label="创建人员" prop="createByName">
              <el-input v-model="queryParams.createByName" placeholder="请输入创建" clearable @keyup.enter="handleQuery" />
            </el-form-item>
    ...
    >
      ...
      <el-table v-loading="loading" border :data="noticeList" height="100%" class="flex-1" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="创建者" align="center" prop="createByName" width="160" />
    ...
    <NoticeFormDialog ref="noticeFormDialogRef" :sys_notice_status="sys_notice_status" :sys_notice_type="sys_notice_type" @success="getList" />
  </div>
</template>

<script setup data-name="Notice" lang="ts">
...
/** 新增按钮操作 */
const handleAdd = () => {
  noticeFormDialogRef.value?.openAdd();
};

/**修改按钮操作 */
const handleUpdate = async (row?: NoticeVO) => {
  const noticeId = row?.noticeId || ids.value[0];
  noticeFormDialogRef.value?.openEdit(noticeId);
};
